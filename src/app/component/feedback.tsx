  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
        ...
        <div className="bg-green-100 shadow-lg p-6 rounded-lg relative">
        ...
        <div className="bg-white shadow-lg p-6 rounded-lg relative">
          ...
          <blockquote className="italic text-gray-600 ml-12">
            From the fabric to the fit, everything about my purchase was top-notch. The website was easy to navigate, and my order arrived in no time. Fantastic experience!
          </blockquote>
        </div>
      </div>
    </div>
